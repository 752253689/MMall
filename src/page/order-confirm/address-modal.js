/*
* @Author: 孙宇鹏
* @Date:   2018-01-13 20:19:01
* @Last Modified by:   孙宇鹏
* @Last Modified time: 2018-01-14 17:50:17
*/
...
var addressModal = {
   ...
   bindEvent : function(){
        ...
        this.$modalWrap.find('.address-btn').click(function(){
            ...
            if(!isUpdate && receiverInfo.status){
                _address.save(receiverInfo.data,function(res){
                    ...
                    _this.hide();
                    typeof _this.option.onSuccess === 'function' && _this.option
                    .onSuccess(res);
                },function(errMsg){
        ...
        //保证点击model内容区的时候不关闭弹床，阻止事件冒泡到.modal-container
